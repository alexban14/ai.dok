...
from app.api.endpoints.interaction import process_file, rag_pipeline
...
def create_api():
    ...
    api.include_router(rag_pipeline.router, prefix=llmInteractionPrefix, tags=['LLmInteractionApi', 'RagPipeline'])
